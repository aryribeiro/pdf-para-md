...
- OCR automático em páginas escaneadas quando o Tesseract está disponível no sistema
...
3. O `packages.txt` (incluído) instala o Tesseract OCR automaticamente — habilita a conversão de PDFs escaneados. Se não for necessário, o arquivo pode ser removido sem afetar PDFs com texto nativo
4. Deploy
...
- **Tesseract OCR** (opcional) — leitura de páginas escaneadas
